...
<head>
    ...
    <title>Report Found Item - UniFind</title>
...
<main class="form-page">
    <div class="form-card">
        <span class="status-pill found-pill">FOUND REPORT</span>
        <h1>Report Found Item</h1>
        <p class="muted">Share enough information so the owner can identify the item.</p>
        ...
        <form method="POST" enctype="multipart/form-data" class="form-stack">
            <div class="form-grid">
                <div>
                    ...
                    <input type="text" name="item_name" value="<?= e($_POST["item_name"] ?? "") ?>" placeholder="Blue water bottle" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="location" value="<?= e($_POST["location"] ?? "") ?>" placeholder="University Canteen" required>
                </div>
            ...
            <div>
                ...
                <textarea name="description" placeholder="Colour, brand and visible details..." required><?= e($_POST["description"] ?? "") ?></textarea>
            </div>
            ...
            <button class="btn btn-block" type="submit">Submit Found Report</button>
        </form>
    </div>
</main>
